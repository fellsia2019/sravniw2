 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */t.widget("ui.tooltip",{version:"1.12.1",options:{classes:{"ui-tooltip":"ui-corner-all ui-widget-shadow"},content:function(){var e=t(this).attr("title")||"";return t("<a>").text(e).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,track:!1,close:null,open:null},_addDescribedBy:function(e,i){var s=(e.attr("aria-describedby")||"").split(/\s+/);s.push(i),e.data("ui-tooltip-id",i).attr("aria-describedby",t.trim(s.join(" ")))},_removeDescribedBy:function(e){var i=e.data("ui-tooltip-id"),s=(e.attr("aria-describedby")||"").split(/\s+/),n=t.inArray(i,s);-1!==n&&s.splice(n,1),e.removeData("ui-tooltip-id"),(s=t.trim(s.join(" ")))?e.attr("aria-describedby",s):e.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"}),this.tooltips={},this.parents={},this.liveRegion=t("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).appendTo(this.document[0].body),this._addClass(this.liveRegion,null,"ui-helper-hidden-accessible"),this.disabledTitles=t([])},_setOption:function(e,i){var s=this;this._super(e,i),"content"===e&&t.each(this.tooltips,(function(t,e){s._updateContent(e.element)}))},_setOptionDisabled:function(t){this[t?"_disable":"_enable"]()},_disable:function(){var e=this;t.each(this.tooltips,(function(i,s){var n=t.Event("blur");n.target=n.currentTarget=s.element[0],e.close(n,!0)})),this.disabledTitles=this.disabledTitles.add(this.element.find(this.options.items).addBack().filter((function(){var e=t(this);if(e.is("[title]"))return e.data("ui-tooltip-title",e.attr("title")).removeAttr("title")})))},_enable:function(){this.disabledTitles.each((function(){var e=t(this);e.data("ui-tooltip-title")&&e.attr("title",e.data("ui-tooltip-title"))})),this.disabledTitles=t([])},open:function(e){var i=this,s=t(e?e.target:this.element).closest(this.options.items);s.length&&!s.data("ui-tooltip-id")&&(s.attr("title")&&s.data("ui-tooltip-title",s.attr("title")),s.data("ui-tooltip-open",!0),e&&"mouseover"===e.type&&s.parents().each((function(){var e,s=t(this);s.data("ui-tooltip-open")&&((e=t.Event("blur")).target=e.currentTarget=this,i.close(e,!0)),s.attr("title")&&(s.uniqueId(),i.parents[this.id]={element:this,title:s.attr("title")},s.attr("title",""))})),this._registerCloseHandlers(e,s),this._updateContent(s,e))},_updateContent:function(t,e){var i,s=this.options.content,n=this,o=e?e.type:null;if("string"==typeof s||s.nodeType||s.jquery)return this._open(e,t,s);(i=s.call(t[0],(function(i){n._delay((function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))}))})))&&this._open(e,t,i)},_open:function(e,i,s){var n,o,a,r,l=t.extend({},this.options.position);function h(t){l.of=t,o.is(":hidden")||o.position(l)}s&&((n=this._find(i))?n.tooltip.find(".ui-tooltip-content").html(s):(i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),n=this._tooltip(i),o=n.tooltip,this._addDescribedBy(i,o.attr("id")),o.find(".ui-tooltip-content").html(s),this.liveRegion.children().hide(),(r=t("<div>").html(o.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"),r.removeAttr("id").find("[id]").removeAttr("id"),r.appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:h}),h(e)):o.position(t.extend({of:i},this.options.position)),o.hide(),this._show(o,this.options.show),this.options.track&&this.options.show&&this.options.show.delay&&(a=this.delayedShow=setInterval((function(){o.is(":visible")&&(h(l.of),clearInterval(a))}),t.fx.interval)),this._trigger("open",e,{tooltip:o})))},_registerCloseHandlers:function(e,i){var s={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var s=t.Event(e);s.currentTarget=i[0],this.close(s,!0)}}};i[0]!==this.element[0]&&(s.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(s.mouseleave="close"),e&&"focusin"!==e.type||(s.focusout="close"),this._on(!0,i,s)},close:function(e){var i,s=this,n=t(e?e.currentTarget:this.element),o=this._find(n);o?(i=o.tooltip,o.closing||(clearInterval(this.delayedShow),n.data("ui-tooltip-title")&&!n.attr("title")&&n.attr("title",n.data("ui-tooltip-title")),this._removeDescribedBy(n),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,(function(){s._removeTooltip(t(this))})),n.removeData("ui-tooltip-open"),this._off(n,"mouseleave focusout keyup"),n[0]!==this.element[0]&&this._off(n,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,(function(e,i){t(i.element).attr("title",i.title),delete s.parents[e]})),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1))):n.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip"),s=t("<div>").appendTo(i),n=i.uniqueId().attr("id");return this._addClass(s,"ui-tooltip-content"),this._addClass(i,"ui-tooltip","ui-widget ui-widget-content"),i.appendTo(this._appendTo(e)),this.tooltips[n]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_appendTo:function(t){var e=t.closest(".ui-front, dialog");return e.length||(e=this.document[0].body),e},_destroy:function(){var e=this;t.each(this.tooltips,(function(i,s){var n=t.Event("blur"),o=s.element;n.target=n.currentTarget=o[0],e.close(n,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))})),this.liveRegion.remove()}}),!1!==t.uiBackCompat&&t.widget("ui.tooltip",t.ui.tooltip,{options:{tooltipClass:null},_tooltip:function(){var t=this._superApply(arguments);return this.options.tooltipClass&&t.tooltip.addClass(this.options.tooltipClass),t}});t.ui.tooltip})),function(t,e){"function"==typeof define&&define.amd?define([],(function(){return t.svg4everybody=e()})):"object"==typeof module&&module.exports?module.exports=e():t.svg4everybody=e()}(this,(function(){
/*! svg4everybody v2.1.9 | github.com/jonathantneal/svg4everybody */
function t(t,e,i,s){if(i){var n=document.createDocumentFragment(),o=!e.hasAttribute("viewBox")&&i.getAttribute("viewBox");o&&e.setAttribute("viewBox",o);for(var a=document.importNode?document.importNode(i,!0):i.cloneNode(!0),r=document.createElementNS(e.namespaceURI||"http://www.w3.org/2000/svg","g");a.childNodes.length;)r.appendChild(a.firstChild);if(s)for(var l=0;s.attributes.length>l;l++){var h=s.attributes[l];"xlink:href"!==h.name&&"href"!==h.name&&r.setAttribute(h.name,h.value)}n.appendChild(r),t.appendChild(n)}}function e(e,i){e.onreadystatechange=function(){if(4===e.readyState){var s=e._cachedDocument;s||((s=e._cachedDocument=document.implementation.createHTMLDocument("")).body.innerHTML=e.responseText,s.domain!==document.domain&&(s.domain=document.domain),e._cachedTarget={}),e._embeds.splice(0).map((function(n){var o=e._cachedTarget[n.id];o||(o=e._cachedTarget[n.id]=s.getElementById(n.id)),t(n.parent,n.svg,o,i)}))}},e.onreadystatechange()}function i(t){for(var e=t;"svg"!==e.nodeName.toLowerCase()&&(e=e.parentNode););return e}return function(s){var n,o=Object(s),a=window.top!==window.self;n="polyfill"in o?o.polyfill:/\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent)||(navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/)||[])[1]<10547||(navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/)||[])[1]<537||/\bEdge\/.(\d+)\b/.test(navigator.userAgent)&&a;var r={},l=window.requestAnimationFrame||setTimeout,h=document.getElementsByTagName("use"),c=0;n&&function s(){if(c&&h.length-c<=0)l(s,67);else{c=0;for(var a=0;a<h.length;){var d=h[a],u=d.parentNode,p=i(u),f=d.getAttribute("xlink:href")||d.getAttribute("href");if(!f&&o.attributeName&&(f=d.getAttribute(o.attributeName)),p&&f){if(n)if(!o.validate||o.validate(f,p,d)){u.removeChild(d);var m=f.split("#"),g=m.shift(),v=m.join("#");if(g.length){var _=r[g];_||((_=r[g]=new XMLHttpRequest).open("GET",g),_.send(),_._embeds=[]),_._embeds.push({parent:u,svg:p,id:v}),e(_,d)}else t(u,p,document.getElementById(v),d)}else++a,++c}else++a}l(s,67)}}()}})),$(".intro-slider").slick({dots:!0,infinite:!0,speed:300,slidesToShow:1,slidesToScroll:1,responsive:[{breakpoint:1080,settings:{arrows:!1,dots:!0}}]}),$(".lot-item__slider").slick({dots:!0,infinite:!0,speed:500,slidesToShow:1,arrows:!1,slidesToScroll:1,arrows:!0,responsive:[{breakpoint:991,settings:{arrows:!1}}]}),$(".slider-info").slick({dots:!0,infinite:!0,speed:300,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:1080,settings:{arrows:!1,dots:!0}},{breakpoint:767.98,settings:{arrows:!1,centerMode:!0,centerPadding:"100px",slidesToShow:1}},{breakpoint:450,settings:{arrows:!1,centerMode:!0,centerPadding:"50px",slidesToShow:1}}]}),$(".slider-document").slick({dots:!0,infinite:!0,speed:300,slidesToShow:4,slidesToScroll:1,responsive:[{breakpoint:991,settings:{arrows:!1,slidesToShow:3,dots:!0}},{breakpoint:767,settings:{arrows:!1,centerMode:!0,centerPadding:"100px",slidesToShow:1}},{breakpoint:500,settings:{arrows:!1,centerMode:!0,centerPadding:"50px",slidesToShow:1}},{breakpoint:420,settings:{arrows:!1,centerMode:!0,centerPadding:"30px",slidesToShow:1}}]}),$((function(){$("#datep").datepicker($.datepicker.regional.ru),$(".mask-tel").mask("+7(999) 999-9999")})),$((function(){$(".request-tabs__input-item[type=date]").datepicker({dateFormat:"yy-mm-dd",constrainInput:!1})})),window.addEventListener("load",(function(){"use strict";let t=document.querySelector(".header-menu__vtbonline-link"),e=document.querySelector(".header-mob__drop-menu"),i=document.querySelector(".header-menu__more-info"),s=document.querySelector(".header-logo"),n=document.querySelector(".header-menu__list"),o=document.querySelector(".header-menu");window.matchMedia("(max-width: 991px)").matches&&e.after(t),window.addEventListener("resize",(function(){window.matchMedia("(max-width: 991px)").matches&&e.after(t)}),!1),window.matchMedia("(min-width: 992px)").matches&&i.after(t),window.addEventListener("resize",(function(){window.matchMedia("(min-width: 992px)").matches&&i.after(t)}),!1),window.matchMedia("(max-width: 991px)").matches&&n.before(s),window.addEventListener("resize",(function(){window.matchMedia("(max-width: 991px)").matches&&n.before(s)}),!1),window.matchMedia("(min-width: 992px)").matches&&o.before(s),window.addEventListener("resize",(function(){window.matchMedia("(min-width: 992px)").matches&&o.before(s)}),!1)})),isMobile={Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return isMobile.Android()||isMobile.BlackBerry()||isMobile.iOS()||isMobile.Opera()||isMobile.Windows()}},window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".dropdown-header__list_before-item"),e=document.querySelector(".dropdown-header__wrapper-right"),i=document.querySelectorAll(".dropdown-header__list-left");function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("dropdown-header__list-left_show"),i[e].classList.add("dropdown-header__list-left_hide")}function n(t){i[t].classList.contains("dropdown-header__list-left_hide")&&(i[t].classList.remove("dropdown-header__list-left_hide"),i[t].classList.add("dropdown-header__list-left_show"))}if(s(1),e.addEventListener("mouseover",(function(e){e.preventDefault();let i=e.target;if(i&&i.classList.contains("dropdown-header__list_before-item"))for(let e=0;e<t.length;e++)if(i==t[e]){s(0),n(e);break}})),isMobile.any()){let t=document.querySelectorAll(".dropdown-header__list_before-item"),e=document.querySelector(".dropdown-header__wrapper-right"),i=document.querySelectorAll(".dropdown-header__list-left");function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("dropdown-header__list-left_show"),i[e].classList.add("dropdown-header__list-left_hide")}function n(t){i[t].classList.contains("dropdown-header__list-left_hide")&&(i[t].classList.remove("dropdown-header__list-left_hide"),i[t].classList.add("dropdown-header__list-left_show"))}s(1),e.addEventListener("click",(function(e){e.preventDefault();let i=e.target;if(i&&i.classList.contains("dropdown-header__list_before-item"))for(let e=0;e<t.length;e++)if(i==t[e]){s(0),n(e);break}}))}}));let infomerMobile=document.querySelector(".infomer__mob"),infomerMobileContent=document.querySelector(".news-infomer__text-item"),newsInfomerTextItem=document.querySelector(".news-infomer__item-wrap");window.addEventListener("load",(function(){"use strict";null!=infomerMobile&&(window.matchMedia("(max-width: 991px)").matches&&infomerMobile.append(infomerMobileContent),window.addEventListener("resize",(function(){window.matchMedia("(max-width: 991px)").matches&&infomerMobile.append(infomerMobileContent)}),!1),window.matchMedia("(min-width: 992px)").matches&&newsInfomerTextItem.append(infomerMobileContent),window.addEventListener("resize",(function(){window.matchMedia("(min-width: 992px)").matches&&newsInfomerTextItem.append(infomerMobileContent)}),!1),window.matchMedia("(max-width: 575px)").matches&&newsInfomerTextItem.append(infomerMobileContent),window.addEventListener("resize",(function(){window.matchMedia("(max-width: 575px)").matches&&newsInfomerTextItem.append(infomerMobileContent)}),!1))}));let contentInfomerMobile=document.querySelector(".content-infomer__mob"),ContentPageinfomerMobileContent=document.querySelector(".content-infomer__text-item"),ContentInfomerTextItem=document.querySelector(".content-infomer__item-wrap");window.addEventListener("load",(function(){"use strict";null!=contentInfomerMobile&&(window.matchMedia("(max-width: 991px)").matches&&contentInfomerMobile.append(ContentPageinfomerMobileContent),window.addEventListener("resize",(function(){window.matchMedia("(max-width: 991px)").matches&&contentInfomerMobile.append(ContentPageinfomerMobileContent)}),!1),window.matchMedia("(min-width: 992px)").matches&&ContentInfomerTextItem.append(ContentPageinfomerMobileContent),window.addEventListener("resize",(function(){window.matchMedia("(min-width: 992px)").matches&&ContentInfomerTextItem.append(ContentPageinfomerMobileContent)}),!1),window.matchMedia("(max-width: 575px)").matches&&ContentInfomerTextItem.append(ContentPageinfomerMobileContent),window.addEventListener("resize",(function(){window.matchMedia("(max-width: 575px)").matches&&ContentInfomerTextItem.append(ContentPageinfomerMobileContent)}),!1))}));let selectNews=document.querySelectorAll(".news-select__item-ui"),selectVacancies=document.querySelectorAll(".vacancies-filter__select-item"),headerSelect=document.querySelectorAll(".header-top__select-item"),requestSelect=document.querySelectorAll(".request__select-local"),requestSelectOther=document.querySelectorAll(".request__select-other"),calcSelect=document.querySelectorAll(".calculator-item__functional-select");$(document).ready((function(){$(selectNews).selectmenu(),$(selectVacancies).selectmenu(),$(headerSelect).selectmenu({icons:{button:"ui-icon-blank"}}),$(requestSelect).selectmenu(),$(requestSelectOther).selectmenu(),$(calcSelect).selectmenu()})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".crediting-inside__tabs-link_tab"),e=document.querySelector(".crediting-inside__tabs-links"),i=document.querySelectorAll(".crediting-inside__tabs-content");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("crediting-inside__tabs-content_show"),i[e].classList.add("crediting-inside__tabs-content_hide")}s(1),e.addEventListener("click",(function(e){e.preventDefault();let n=e.target;if(n&&n.classList.contains("crediting-inside__tabs-link_tab"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("crediting-inside__tabs-content_hide")&&(i[o].classList.remove("crediting-inside__tabs-content_hide"),i[o].classList.add("crediting-inside__tabs-content_show"));break}var o}))}}));let tabCreditingActive=document.querySelectorAll(".crediting-inside__tabs-link_tab");$(document).ready((function(){$(".crediting-inside__tabs-link_tab").on("click",(function(t){$(tabCreditingActive).removeClass("tab-item_active"),$(this).toggleClass("tab-item_active")}))})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".vacancies-filter__checkbox-label"),e=document.querySelector(".vacancies-filter"),i=document.querySelectorAll(".vacancies-content");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("vacancies-content_show"),i[e].classList.add("vacancies-content_hide")}s(1),e.addEventListener("click",(function(e){let n=e.target;if(n&&n.classList.contains("vacancies-filter__checkbox-label"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("vacancies-content_hide")&&(i[o].classList.remove("vacancies-content_hide"),i[o].classList.add("vacancies-content_show"));break}var o}))}})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".vacancies-filter__checkbox-label"),e=document.querySelector(".management-filter__item"),i=document.querySelectorAll(".management-body__content-tabs");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("management-body__content-tabs_show"),i[e].classList.add("management-body__content-tabs_hide")}s(1),e.addEventListener("click",(function(e){let n=e.target;if(n&&n.classList.contains("vacancies-filter__checkbox-label"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("management-body__content-tabs_hide")&&(i[o].classList.remove("management-body__content-tabs_hide"),i[o].classList.add("management-body__content-tabs_show"));break}var o}))}})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".main-tabs__tab"),e=document.querySelector(".main-tabs__left-content"),i=document.querySelectorAll(".main-tabs__right-content");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("main-tabs__right-content_show"),i[e].classList.add("main-tabs__right-content_hide")}s(1),e.addEventListener("click",(function(e){e.preventDefault();let n=e.target;if(n&&n.classList.contains("main-tabs__tab"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("main-tabs__right-content_hide")&&(i[o].classList.remove("main-tabs__right-content_hide"),i[o].classList.add("main-tabs__right-content_show"));break}var o}))}}));let tabHomeActive=document.querySelectorAll(".main-tabs__tab");$(document).ready((function(){$(".main-tabs__tab").on("click",(function(t){$(tabHomeActive).removeClass("main-tabs__tab_active"),$(this).toggleClass("main-tabs__tab_active")}))})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".map-filter__radio-label"),e=document.querySelector(".map-filter__radio"),i=document.querySelectorAll(".addresses-tabs__item");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("addresses-tabs__item_show"),i[e].classList.add("addresses-tabs__item_hide")}s(1),e.addEventListener("click",(function(e){let n=e.target;if(n&&n.classList.contains("map-filter__radio-label"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("addresses-tabs__item_hide")&&(i[o].classList.remove("addresses-tabs__item_hide"),i[o].classList.add("addresses-tabs__item_show"));break}var o}))}})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".requisites-currency__label-checkbox"),e=document.querySelector(".requisites-currency__radio"),i=document.querySelectorAll(".requisites-currency__info-wrapper");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("requisites-currency__info-wrapper_show"),i[e].classList.add("requisites-currency__info-wrapper_hide")}s(1),e.addEventListener("click",(function(e){let n=e.target;if(n&&n.classList.contains("requisites-currency__label-checkbox"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("requisites-currency__info-wrapper_hide")&&(i[o].classList.remove("requisites-currency__info-wrapper_hide"),i[o].classList.add("requisites-currency__info-wrapper_show"));break}var o}))}})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".header-menu__top-link"),e=document.querySelector(".header-menu__top-list"),i=document.querySelectorAll(".header-menu__list");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("header-menu__list_show"),i[e].classList.add("header-menu__list_hide")}s(1),e.addEventListener("click",(function(e){e.preventDefault();let n=e.target;if(n&&n.classList.contains("header-menu__top-link"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("header-menu__list_hide")&&(i[o].classList.remove("header-menu__list_hide"),i[o].classList.add("header-menu__list_show"));break}var o}))}}));let header_tab=document.querySelectorAll(".header-menu__top-link");$(header_tab).on("click",(function(t){$(header_tab).removeClass("header-menu__toplink--active"),$(this).toggleClass("header-menu__toplink--active")})),window.addEventListener("load",(function(){"use strict";let t=document.querySelectorAll(".request-tabs__item-tab"),e=document.querySelector(".request-tabs__item"),i=document.querySelectorAll(".request-tabs__content-item");if(null!=e){function s(t){for(let e=t;e<i.length;e++)i[e].classList.remove("request-tabs__content-item_show"),i[e].classList.add("request-tabs__content-item_hide")}s(1),e.addEventListener("click",(function(e){e.preventDefault();let n=e.target;if(n&&n.classList.contains("request-tabs__item-tab"))for(let e=0;e<t.length;e++)if(n==t[e]){s(0),i[o=e].classList.contains("request-tabs__content-item_hide")&&(i[o].classList.remove("request-tabs__content-item_hide"),i[o].classList.add("request-tabs__content-item_show"));break}var o}))}}));let tabActive=document.querySelectorAll(".request-tabs__item-tab");$(".request-tabs__item-tab").on("click",(function(t){$(tabActive).removeClass("tab-item_active"),$(this).toggleClass("tab-item_active")}));